/**
 * Strip Markdown Formatting Utility (Edge Function Version)
 *
 * Removes markdown syntax while preserving plain text content.
 * Used in AI comment creation to standardize text offset calculations.
 *
 * This matches the frontend implementation in src/utils/stripMarkdown.ts
 * to ensure consistent plain text coordinate systems between user-created
